...
This repository (DegentClub/degent) builds software that constructs and signs Bitcoin transactions. We treat a vulnerability
...
1. Preferred: GitHub private vulnerability reporting. Go to the **Security** tab of this repository and choose
   **Report a vulnerability** (<https://github.com/DegentClub/degent/security/advisories/new>). Only the maintainers and
