...
| `contracts/` | Contracts **this product provides**: `openapi/degent-mint.yaml`, `asyncapi/degent-mint.yaml`, `openapi/degent-market.yaml`, `asyncapi/degent-market.yaml`. Platform contracts are at `deps/scribbit/contracts/` |
