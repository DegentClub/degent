...
| You have | Go to |
|---|---|
| A question, an idea, or want to show what you built | [Discussions](https://github.com/DegentClub/degent/discussions) |
| A bug | [Bug report](https://github.com/DegentClub/degent/issues/new?template=bug.yml) |
| A wallet that behaves differently from what we document | [Wallet compatibility report](https://github.com/DegentClub/degent/issues/new?template=wallet-compatibility.yml) |
| A feature request | [Feature request](https://github.com/DegentClub/degent/issues/new?template=feature.yml) |
| A security vulnerability | **Privately**, via [Report a vulnerability](https://github.com/DegentClub/degent/security/advisories/new); see [SECURITY.md](SECURITY.md) |
...
This repository pins the platform (`deps/scribbit`) to a specific commit; that pinned commit is the supported platform version for this repository. Platform questions and bugs go to [DegentClub/scribbit](https://github.com/DegentClub/scribbit/issues/new/choose).
