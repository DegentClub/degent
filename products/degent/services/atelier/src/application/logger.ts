/** Structured JSON logger. Callers must never pass tokens, API keys or provider request bodies as fields. */
...
export const jsonLogger = (service = 'degent-atelier'): Logger => {
