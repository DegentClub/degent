 ...
 * sees a partial blob. Reads re-hash and refuse corrupted files. (Same shape as the mint's store;
 * components share code only via platform/ and contracts/, so it is re-implemented here.)
 */
