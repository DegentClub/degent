/** Structured JSON logger. Callers must never pass PSBTs, signatures, challenge messages or keys as fields. */
...
export const jsonLogger = (service = 'degent-market'): Logger => {
