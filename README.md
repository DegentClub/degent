...
|---|---|
| **DegentClub/degent** (this repo) | `degent-web` (mint front end), `degent-mint` (mint service), `degent-mint-sdk` (rules, types, API client), `degent-market` + `degent-market-sdk` (marketplace), their contracts, ADRs |
