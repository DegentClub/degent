...
|---|---|
| **DegentClub/degent** (this repo) | `degent-web` (mint front end), `degent-mint` (mint service), `degent-mint-sdk` (rules, types, API client), `degent-telegram-gate` (holders-only Telegram gate), `degent-x-bot` (X content engine), their contracts, ADR-0002 |
